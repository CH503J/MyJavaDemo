...
public class TranslateDemo {
    ...
    private static final String APP_KEY = "1dbe35d297b06b78";     // 您的应用ID
    private static final String APP_SECRET = "cJiJnQBgZZ1muX4TGgvYSaDkBLXTuK3S";  // 您的应用密钥
    ...
    private static Map<String, String[]> createRequestParams() {
         ...
         */
        String q = "Enabling this will speed up discovery of plugins and patchers by caching the metadata of all types BepInEx discovers.";
        String from = "en";
        String to = "zh-CHS";
