...
public class GenConstants {
    ...
    public static final String[] COLUMNNAME_NOT_EDIT = {"id","create_by" , "create_time" ,
            "update_by" , "ancestors",
            "update_time" , "is_delete" , "corp_code" , "version"};
    ...
    public static final String[] COLUMNNAME_NOT_QUERY = {"id","create_by" , "create_time" ,
            "update_by" , "ancestors", "parent_id", "order_num",
            "update_time" , "is_delete" , "corp_code" , "version"};

    /**
     * Entity基类字段
     */
    public static final String[] BASE_ENTITY = {"id","createBy" , "createTime" , "updateBy" ,
            "updateTime" , "isDelete" , "corpCode" , "version"};
     ...
     * controller 模板字段
     */
    public static final String CONTROLLER_TEMPLATE = "controller";
